...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    //Inserir no banco
    $sql = "INSERT INTO depoimentos (id_usuario, conteudo, data_post, foto, video)
            VALUES (?, ?, ?, ?, ?)";
    $stmt = $pdo->prepare($sql);
    $stmt->execute([$id_usuario, $conteudo, $data_post, $foto, $video]);

    echo "Depoimento cadastrado com sucesso!";
...
<head>
    ...
    <title>Adicionar Depoimento - iNutre</title>
...
<body>
    ...
    <form action="adicionar_depoimento.php" method="POST" enctype="multipart/form-data">
    <input type="hidden" name="id_usuario" value="id_usuario">

    <label for="conteudo">Depoimento:</label><br>
    ...
    <input type="url" name="video_link" placeholder="Link do vídeo: "><br>
    ou<br>
